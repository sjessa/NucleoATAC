...
class NFRParameters:
    ...
    def __init__(self, occ_track,calls, ins_track = None, input_file = None, input_type = None,
                 max_occ = 0.25, max_occ_upper = 0.25, fasta = None, pwm = None):
...
class NFRChunk(Chunk):
    ...
    def getIns(self):
        ...
        if self.params.ins_track is None:
            ...
            self.ins.calculateInsertions(input_file = self.params.input_file,
